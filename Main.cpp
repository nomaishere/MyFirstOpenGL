...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Select Orthographic Projection or Perspective Projection by need of distance
		// First Param: POV, Second Param: divide width by height, Third & Fourth: Near Plane & Far Plane
